...
"""
import zipfile, tarfile, os, urllib.request
...
def ensure_index_html():
    """index.html is generated by pygbag on first setup — just warn if missing."""
    if not (BUILD / "index.html").exists():
        print("\nWARNING: build/web/index.html not found.")
        print("Run this once to generate it:")
        print("  python -m pygbag --port 8000 main.py")
